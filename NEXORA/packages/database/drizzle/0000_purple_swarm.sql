...
CREATE TABLE "users" (
	...
	"privacy" jsonb DEFAULT '{"showEmail":true,"showSkills":true}'::jsonb NOT NULL,
...
ALTER TABLE "job_titles" ADD CONSTRAINT "job_titles_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "job_titles" ADD CONSTRAINT "job_titles_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "organization_memberships" ADD CONSTRAINT "organization_memberships_department_id_departments_id_fk" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_memberships" ADD CONSTRAINT "organization_memberships_team_id_teams_id_fk" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "organization_memberships" ADD CONSTRAINT "organization_memberships_job_title_id_job_titles_id_fk" FOREIGN KEY ("job_title_id") REFERENCES "public"."job_titles"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "departments_org_slug_unique" ON "departments" USING btree ("organization_id","slug");--> statement-breakpoint
CREATE INDEX "departments_org_idx" ON "departments" USING btree ("organization_id");--> statement-breakpoint
CREATE UNIQUE INDEX "job_titles_org_norm_unique" ON "job_titles" USING btree ("organization_id","name_norm");--> statement-breakpoint
CREATE UNIQUE INDEX "skills_org_norm_unique" ON "skills" USING btree ("organization_id","name_norm");--> statement-breakpoint
CREATE UNIQUE INDEX "teams_dept_slug_unique" ON "teams" USING btree ("department_id","slug");--> statement-breakpoint
...
CREATE INDEX "user_skills_org_skill_idx" ON "user_skills" USING btree ("organization_id","skill_id");--> statement-breakpoint
...
CREATE INDEX "memberships_dept_idx" ON "organization_memberships" USING btree ("department_id");--> statement-breakpoint
CREATE INDEX "memberships_team_idx" ON "organization_memberships" USING btree ("team_id");--> statement-breakpoint
