...
CREATE TABLE "organizations" (
	...
	"slug" text NOT NULL,
	"logo_url" text,
	"plan" text DEFAULT 'open-source' NOT NULL,
...
CREATE UNIQUE INDEX "departments_org_name_unique" ON "departments" USING btree ("organization_id",lower("name"));--> statement-breakpoint
...
CREATE UNIQUE INDEX "teams_dept_name_unique" ON "teams" USING btree ("department_id",lower("name"));--> statement-breakpoint
